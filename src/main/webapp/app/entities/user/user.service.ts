...
export class UserService {
  ...
  private resourceSponsoredByUrl = this.applicationConfigService.getEndpointFor('api/code-parrain');
  ...
  getSponsoredBy(codeParrainage: string | null): Observable<any>{
    return this.http.get<IUser>(this.resourceSponsoredByUrl + '/' + codeParrainage);
  }
